...
public class MyGraph<V>  {
    ...
    public void addVertex(V data) {vertices.put(data, new Vertex<>(data));}
    public void addEdge(V source, V dest){addEdge(source, dest, 1.0);}
    ...
    public Map<V, Vertex<V>> getVertices(){ return vertices;}
